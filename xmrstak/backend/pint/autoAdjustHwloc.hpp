...
#include "./config.tpl"
		...
		{
			printer::inst()->print_msg(L0, "WARNING: CPU mining will be disabled because cryptonight_gpu is not suitable for CPU mining. You can uncomment the auto generated config in %s to enable CPU mining.", params::inst().configFilePPU.c_str());
		...
		printer::inst()->print_msg(L0, "CPU configuration stored in file '%s'", params::inst().configFilePPU.c_str());
